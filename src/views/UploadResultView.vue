  ...
  <main>
    <div class="step-info">
      ...
      <span
        ...
        <RouterLink to="/upload-course" class="link">skip</RouterLink></span
      >
    </div>
    <Accordion @open="">
      ...
      <template #content>
        <Upload
          ...
          @file-added="filePresent = true"
          @file-removed="filePresent = false"
        ...
        <div class="panel-units">
          ...
          <button
            :class="{ inactive: store.numberOfUnits <= 0 }"
            :disabled="store.numberOfUnits <= 0"
            @click="uploadDone"
            type="button"
          >
            Continue
    ...
    <Accordion @open="">
      ...
      <template #description
        >Manually enter CGPA and units for past semesters</template
      >
      <template #content>
        <form
          class="content"
